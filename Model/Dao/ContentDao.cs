...
namespace Model.Dao
{
    ...
    public class ContentDao
    {
        ...
        public List<Content> ListFeatureContent(int top)
        {
            return db.Contents.OrderByDescending(x => x.CreatedDate).Take(top).ToList().Take(top).ToList();
        }
        ...
        // }
        public Content ViewDetailContent(long id)
        {
            return db.Contents.Find(id);
        }
    }
