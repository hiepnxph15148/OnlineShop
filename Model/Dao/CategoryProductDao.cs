...
namespace Model.Dao
{
    public class CategoryProductDao
    {
        ...
        public List<ProductCategory> ListAll()
       {
        ...
        public ProductCategory ViewDetailcate(long id)
        {
            return db.ProductCategories.Find(id);
        }
       
        public ProductCategory ViewDetailcate2(string Categoryid)
        {
            return db.ProductCategories.SingleOrDefault(x=> x.Name == Categoryid);
        }
